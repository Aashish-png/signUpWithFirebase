...
////new functinon for notifications-------------------------------------
// OnNotify(){
//   debugger
...
//   this.crudSer.userData()

//   alert("off notifcations")
// }
...
copy() {
  ...
  document.getElementById('copy1').style.background = '#0000009e';
